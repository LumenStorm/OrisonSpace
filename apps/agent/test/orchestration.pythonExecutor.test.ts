...
import { executePythonNode } from '../src/engine/pythonNodeExecutor';
  ...
  it('executes the runner and parses a success payload', async () => {
    const result = await executePythonNode({
      ...
      request: {
        ...
        nodeFile: 'python/nodes/story_planner_agent.py',
        ...
        config: {
          ...
          prompt: { file: './prompts/story-planner.yaml', systemKey: 'system', userKey: 'user' },

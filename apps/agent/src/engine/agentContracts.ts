...
const contracts: AgentContract[] = [
  ...
  },
  {
    ...
    goal: '根据指定集纲写初稿',
    owns: [],
    reads: ['episode_outlines', 'foreshadow_registry', 'world_setting', 'asset_cards', 'growth_curve', 'pacing_curve', 'emotion_curve'],
  ...
  },
  {
    ...
    owns: [],
    reads: ['creative_brief', 'world_setting', 'outline', 'episode_outlines', 'foreshadow_registry', 'growth_curve', 'pacing_curve', 'emotion_curve', 'asset_cards', 'relationship_graph'],
  ...
  },
  {
    ...
    goal: '按审稿意见做定向修订',
    owns: [],
    reads: ['creative_brief', 'world_setting', 'outline', 'episode_outlines', 'foreshadow_registry', 'asset_cards', 'relationship_graph'],
    must: ['只改 review 指定范围'],
    mustNot: ['无理由扩大改动范围'],
